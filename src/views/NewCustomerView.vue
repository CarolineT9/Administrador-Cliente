...
<template>
    ...
    <div class="mx-auto mt-10 bg-white shadow">
        <div class="mx-auto md:w-2/3 py-20 px-6">
            <FormKit type="form" @submit="handleSubmit" submit-label="Add Customer">
                <FormKit type="text" label="First name" name="first_name" placeholder="Customer's first name"
                    validation="required" validation-visibility="live" />
                <FormKit type="text" label="Last name" name="last_name" placeholder="Customer's last name"
                    validation="required" validation-visibility="live" />
                <FormKit type="email" label="E-mail" name="email" placeholder="customer@email.com"
                ...
                <FormKit type="text" label="Work location" name="work_location"
